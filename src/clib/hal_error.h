...
HAL_ERROR_DEF(HAL_ALLOCATE_FAIL)        //-9999
HAL_ERROR_DEF(HAL_INIT_REPETITIVE)      //-9998
HAL_ERROR_DEF(HAL_OPEN_FILE_FAIL)       //-9997
HAL_ERROR_DEF(HAL_UNEXPECTED_ERROR)     //-9996
HAL_ERROR_DEF(HAL_EBUSY)                //-9995
HAL_ERROR_DEF(HAL_TOO_MANY_THREADS)     //-9994
HAL_ERROR_DEF(HAL_QUEUE_FULL)           //-9993
HAL_ERROR_DEF(HAL_QUEUE_EMPTY)          //-9992
#endif
